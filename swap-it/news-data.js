        ...
        announcements: [
            {
                date: "2026-07-08",
                tag: "即將上線",
                title: "🚀 1.9.0 即將上線：多效期庫存、自訂欄位與更聰明的多份使用管理",
        ...
        announcements: [
            {
                date: "2026-07-08",
                tag: "Coming Soon",
                title: "🚀 1.9.0 Coming Soon: Batch Expiry, Custom Fields, and Smarter Multi-Instance Usage",
        ...
        announcements: [
            {
                date: "2026-07-08",
                tag: "まもなく公開",
                title: "🚀 1.9.0 まもなく公開：バッチごとの期限管理、カスタムフィールド、よりスマートな複数使用管理",
        ...
        announcements: [
            {
                date: "2026-07-08",
                tag: "출시 예정",
                title: "🚀 1.9.0 출시 예정: 재고별 유통기한, 사용자 정의 필드 및 더 스마트한 여러 개 사용 관리",
                content: "이번 1.9.0 업데이트에서는 실제 생활에 더욱 밀접한 기능 업그레이드와 인터페이스 개편을 선보입니다!<br><br>✨ <b>재고별 유통기한 관리</b><br>같은 물품을 다른 배치로 구매하셨나요? 이제 개별 재고에 다른 유통기한을 설정할 수 있습니다! 시스템이 재고를 나누어 관리하고 유통기한이 가장 가까운 것을 우선적으로 알려줍니다.<br><br>✨ <b>사용자 정의 필드 추가</b><br>기본 속성 외에도 이제 물품에 전용 사용자 정의 필드(텍스트 및 날짜 선택기 포함) 단추를 추가할 수 있습니다. 뷰티 제품의 '개봉 후 사용 기간(PAO)'을 기록하는 것이 더욱 쉬워졌습니다.<br><br>✨ <b>여러 개 동시 사용 지원</b><br>모든 물품은 이제 여러 개를 동시에 개봉하여 사용하는 것을 지원합니다! 카드에 각 물품의 사용 상태와 남은 재고가 나란히 명확하게 표시됩니다.<br><br>✨ <b>인터페이스 및 경험 전면 업그레이드</b><br>물품 양식과 상세 페이지의 레이아웃을 재정비하고, 상태 카드도 더 직관적인 카운트다운 디자인으로 변경했습니다. 또한, Android 버전에서 홈 화면 위젯이 사라지거나 알림이 오지 않던 문제를 수정하여 더욱 원활하고 안정적인 사용이 가능해졌습니다."
            }
        ],
        roadmap: [
            {
